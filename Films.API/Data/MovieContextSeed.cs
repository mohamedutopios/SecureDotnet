...
namespace Films.API.Data
{
    ...
    {
        public static void SeedAsync(FilmsAPIContext filmsAPIContext)
        {
            if (!filmsAPIContext.Movie.Any())
            {
                ...
                filmsAPIContext.Movie.AddRange(movies);
                filmsAPIContext.SaveChanges();
            }
        }
    }
